...
async def get_report(request: Request):
    ...
    if search is None:
        return JSONResponse(
            status_code=400,
            content={"response": "Could not find an open report from the user!"},
        )
...
async def add_report(request: Request, report: JsonIssueReport):
    ...
    if search is not None:
        return JSONResponse(
            status_code=400, content={"response": "User already has an open report."}
        )
    object_id = ObjectId()
    ...
    return JSONResponse(
        status_code=200, content={"response": "Successfully Created Report"}
    )
...
async def update_report(request: Request, report: dict):
    ...
    if search is None:
        return JSONResponse(
            status_code=400, content={"response": "Could not find existing report."}
        )
    ...
    return JSONResponse(
        status_code=200, content={"response": "Successfully Patched Existing Report"}
    )
...
async def submit_report(request: Request):
    ...
    if report.description == "":
        return JSONResponse(
            status_code=400, content={"response": "Empty Description is not allowed."}
        )
